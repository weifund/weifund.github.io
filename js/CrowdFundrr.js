...
function load_contract()
{
	...
	if(typeof contract.newCampaign === 'function') {
	    alert("It's a function");
	} else if (typeof contract.newCampaign === 'undefined') {
	    alert("It's undefined");
	} else {
	    alert("It's neither undefined nor a function. It's a " + typeof contract.newCampaign);
	}
